...
def save_solutions(directory_path: str, index_pool: IndexPool,  counts: PieceKeyCounts, pieces: List[T]) -> None:
    streams = SolutionWriteStreams[T](directory_path, pieces)
    solution_searcher = SolutionSearcher[T](index_pool, counts, pieces, streams.append_solution, streams.append_solution_with_prefix)
