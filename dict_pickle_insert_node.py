...
class InsertNode:
    ...
    def load(self, leaf_index: int) -> None:
        self.leaf_index = leaf_index
        current_position = self.file.seek(
            self.positions[leaf_index] - self.current_position, 1
        )
    ...
    def append_index(self, index: int, value: InsertNodeValue | None = None) -> None:
        ...
        self.current_position = self.file.seek(
            self.end_position - self.current_position, 1
        )
